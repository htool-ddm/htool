...
bool test_lrmat_hmatrix_product(const TestCase<T, GeneratorTestType> &test_case, bool use_local_cluster, htool::underlying_type<T> epsilon) {
    ...
    add_lrmat_matrix_product(transa, 'N', alpha, A_auto_approximation, B_dense, beta, matrix_result_w_matrix_sum);
    add_lrmat_matrix_product(transa, 'N', alpha, A_auto_approximation, B_dense, beta, matrix_result_w_lrmat_sum);
    add_lrmat_matrix_product(transa, 'N', alpha, A_auto_approximation, B_dense, T(0), matrix_result_wo_sum);

    // Product
    matrix_test = C_dense;
    add_lrmat_hmatrix_product(transa, 'N', alpha, A_auto_approximation, root_hmatrix, beta, matrix_test);
    ...
    add_lrmat_hmatrix_product(transa, 'N', alpha, A_auto_approximation, root_hmatrix, T(0), lrmat_test);
    ...
    lrmat_test = C_auto_approximation;
    add_lrmat_hmatrix_product(transa, 'N', alpha, A_auto_approximation, root_hmatrix, beta, lrmat_test);
    dense_lrmat_test.resize(lrmat_test.get_U().nb_rows(), lrmat_test.get_V().nb_cols());
    lrmat_test.copy_to_dense(dense_lrmat_test.data());
