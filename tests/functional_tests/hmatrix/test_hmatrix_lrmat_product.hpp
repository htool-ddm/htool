...
bool test_hmatrix_lrmat_product(const TestCase<T, GeneratorTestType> &test_case, bool use_local_cluster, htool::underlying_type<T> epsilon) {
    ...
    add_matrix_lrmat_product(transa, 'N', alpha, A_dense, B_auto_approximation, beta, matrix_result_w_matrix_sum);
    add_matrix_lrmat_product(transa, 'N', alpha, A_dense, B_auto_approximation, beta, matrix_result_w_lrmat_sum);
    add_matrix_lrmat_product(transa, 'N', alpha, A_dense, B_auto_approximation, T(0), matrix_result_wo_sum);

    // Product
    matrix_test = C_dense;
    add_hmatrix_lrmat_product(transa, 'N', alpha, root_hmatrix, B_auto_approximation, beta, matrix_test);
    ...
    add_hmatrix_lrmat_product(transa, 'N', alpha, root_hmatrix, B_auto_approximation, T(0), lrmat_test);
    ...
    lrmat_test = C_auto_approximation;
    add_hmatrix_lrmat_product(transa, 'N', alpha, root_hmatrix, B_auto_approximation, beta, lrmat_test);
    dense_lrmat_test.resize(lrmat_test.get_U().nb_rows(), lrmat_test.get_V().nb_cols());
    lrmat_test.copy_to_dense(dense_lrmat_test.data());
