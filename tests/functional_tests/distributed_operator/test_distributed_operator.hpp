...
#include <htool/local_operators/local_dense_matrix.hpp>      // for LocalDe...
#include <htool/local_operators/local_hmatrix.hpp>           // for LocalHM...
#include <htool/local_operators/local_operator.hpp>          // for LocalOp...
