...
void add_lrmat_matrix_product(char transa, char transb, CoefficientPrecision alpha, const LowRankMatrix<CoefficientPrecision> &A, const Matrix<CoefficientPrecision> &B, CoefficientPrecision beta, Matrix<CoefficientPrecision> &C) {
    ...
    if (rank != 0) {
        ...
        if (transa == 'N') {
            ...
            add_matrix_matrix_product(transa, transb, CoefficientPrecision(1), V, B, CoefficientPrecision(0), VB);
            ...
            add_matrix_matrix_product(transa, transb, CoefficientPrecision(1), U, B, CoefficientPrecision(0), UtB);
    ...
    if (rank != 0) {
        ...
        if (beta == CoefficientPrecision(0) || C.rank_of() == 0) {
            if (transa == 'N') {
                ...
                U_C = U_A;
                add_matrix_matrix_product(transa, transb, alpha, V_A, B, CoefficientPrecision(0), V_C);
            } else {
                ...
                add_matrix_matrix_product(transa, transb, alpha, U_A, B, CoefficientPrecision(0), V_C);
            }
            ...
            if (transa == 'N') {
                ...
                add_matrix_matrix_product(transa, transb, alpha, V_A, B, CoefficientPrecision(0), VB);
            } else {
                ...
                // Compute VB=V_B*B
                VB.resize(V_A.nb_rows(), transb == 'N' ? B.nb_cols() : B.nb_rows());
                add_matrix_matrix_product(transa, transb, alpha, U_A, B, CoefficientPrecision(0), VB);
            }
