...
class partialACA final : public VirtualInternalLowRankGenerator<CoefficientPrecision> {
  ...
  public:
    ...
    partialACA(const VirtualGenerator<CoefficientPrecision> &A, const int *target_permutation, const int *source_permutation) : internal_generator_w_permutation(std::make_unique<InternalGeneratorWithPermutation<CoefficientPrecision>>(A, target_permutation, source_permutation)), m_A(*internal_generator_w_permutation) {}
