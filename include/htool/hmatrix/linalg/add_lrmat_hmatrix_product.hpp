...
void add_lrmat_hmatrix_product(char transa, char transb, CoefficientPrecision alpha, const LowRankMatrix<CoefficientPrecision, CoordinatePrecision> &A, const HMatrix<CoefficientPrecision, CoordinatePrecision> &B, CoefficientPrecision beta, Matrix<CoefficientPrecision> &C) {
    if (transb != 'N') {
    ...
    if (rank != 0) {
        ...
        if (transa == 'N') {
            ...
            add_matrix_hmatrix_product<CoefficientPrecision>(transa, 'N', 1, V, B, 0, VB);
            ...
            add_matrix_hmatrix_product<CoefficientPrecision>(transa, 'N', 1, U, B, 0, UtB);
...
template <typename CoefficientPrecision, typename CoordinatePrecision = CoefficientPrecision>
void add_lrmat_hmatrix_product(char transa, char transb, CoefficientPrecision alpha, const LowRankMatrix<CoefficientPrecision, CoordinatePrecision> &A, const HMatrix<CoefficientPrecision, CoordinatePrecision> &B, CoefficientPrecision beta, LowRankMatrix<CoefficientPrecision, CoordinatePrecision> &C) {
    if (transb != 'N') {
    ...
    if (rank != 0) {
        ...
        if (beta == CoefficientPrecision(0) || C.rank_of() == 0) {
            if (transa == 'N') {
                ...
                U_C = U_A;
                add_matrix_hmatrix_product<CoefficientPrecision>(transa, 'N', alpha, V_A, B, 0, V_C);
            } else {
                V_C.resize(U_A.nb_cols(), B.nb_cols());
                transpose(V_A, U_C);
                add_matrix_hmatrix_product<CoefficientPrecision>(transa, 'N', alpha, U_A, B, 0, V_C);
            }
        } else {
            ...
            if (transa == 'N') {
                ...
                add_matrix_hmatrix_product<CoefficientPrecision>(transa, 'N', alpha, V_A, B, 0, VB);
            } else {
                ...
                // Compute VB=V_B*B
                VB.resize(V_A.nb_rows(), B.nb_cols());
                add_matrix_hmatrix_product<CoefficientPrecision>(transa, 'N', alpha, U_A, B, 0, VB);
            }
