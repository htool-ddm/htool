...
class RestrictedGlobalToLocalOperator : public VirtualGlobalToLocalOperator<CoefficientPrecision> {
  protected:
    ...
    virtual int get_target_offset() const override { return m_local_target_renumbering.get_offset(); }
    virtual int get_source_offset() const override { return m_local_source_renumbering.get_offset(); }
    virtual int get_target_size() const override { return m_local_target_renumbering.get_size(); }
    virtual int get_source_size() const override { return m_local_source_renumbering.get_size(); }
